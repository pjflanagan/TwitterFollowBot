...
bool Twitter::is_follower(Account &a)
{ //---------------------------------- is_follower TODO
	std::string response;
...
bool Twitter::is_friend(Account &a)
{ //------------------------------------ is_friend
	std::string response;
...
void Twitter::unfollow(Account &a)
{ //------------------------------------- unfollow
